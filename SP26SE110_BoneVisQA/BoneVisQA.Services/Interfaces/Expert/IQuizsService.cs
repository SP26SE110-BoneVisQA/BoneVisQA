...
namespace BoneVisQA.Services.Interfaces.Expert
{
    ...
    {
        //=====================================================   QUIZ  ==========================================================
        Task<PagedResult<GetQuizDTO>> GetAllQuizAsync(int pageIndex, int pageSize);
        ...
        //=====================================================   QUESTION  ==========================================================
        Task<List<GetQuizQuestionDTO>> GetQuizQuestionAsync(Guid quizId);
        ...
        //================================================================================================================
        Task<PagedResult<GetClassDTO>> GetAllClassAsync(int pageIndex, int pageSize);
        Task<PagedResult<GetExpertDTO>> GetAllExpertAsync(int pageIndex, int pageSize);
        Task<PagedResult<ClassQuizSessionDTO>> GetAssignQuizAsync(int pageIndex, int pageSize);
        ...
        Task<PagedResult<ExpertQuizForLecturerDto>> GetExpertQuizzesForLecturerAsync(int pageIndex,int pageSize,string? topic = null,string? difficulty = null, string? classification = null);
